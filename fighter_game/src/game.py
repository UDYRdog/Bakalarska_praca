...
class RectangleSheetLoader:
    ...
    def detectRectangle(self, target_point, start_pixel):
        rect_start = target_point - start_pixel
        i = 1
...
if __name__ == "__main__":
    ...
    background_path = os.path.join(base_dir, 'res', 'ArcadeSized.png')
    ken_sprite_path = os.path.join(base_dir, 'res', 'Ken.png')

    background = pygame.image.load(background_path).convert()
    sprite_list = SpriteSheetLoader(ken_sprite_path, 60, 60).getSpriteList()
    gameobj = GameObjectWithHitBox(ken_sprite_path, 60, 60, Point(32,130))
